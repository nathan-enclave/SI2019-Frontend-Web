...
class AnimatedMap extends Component {
    ...
    handleCityClick(city) {
        this.setState({zoom: 2, center: city.coordinates})
    }
    handleReset() {
        this.setState({
            center: [
    ...
    render() {
        return (
            <div style={wrapperStyles}>
                <div className="action-list margin-bottom-md">
                    <button onClick={this.handleZoomIn} className="btn green-meadow">
                        {"Zoom in"}
                    </button>
                    <button onClick={this.handleZoomOut} className="btn blue-chambray  margin-left-md">
                        {"Zoom out"}
                    </button>
