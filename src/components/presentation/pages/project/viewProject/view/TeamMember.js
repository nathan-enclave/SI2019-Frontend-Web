...
class TeamMember extends Component {
    render() {
        let typeLabel = (this.props.role === "leader") ? "danger" :(this.props.role ==="quality assurance")?"info": "success"
        ...
        return (          
          ...
          <div className="item-head">
            ...
            <span className="item-status" style={{marginTop: "-10px",marginRight:"20px"}} >
            <a href={"mailto:" +this.props.email} ><img alt = "" height="30px" width="30px" src = "../assets/img-icon/mail.png"/></a></span>
          </div>
        </div>
        );
    }
